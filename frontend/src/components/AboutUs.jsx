          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="flex">
              ...
              <div className="col-4">
                <br></br>
                <p className="text-lg text-[#000435] bg-white ">
                  <span>  As Gen AI Challengers, our mission is to revolutionize agriculture through advanced artificial intelligence technologies. We are dedicated to creating AI-driven solutions that empower farmers and agribusinesses to optimize productivity, improve sustainability, and tackle the growing challenges of global food security.
