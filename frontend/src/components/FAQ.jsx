  ...
  const faqs = [
    {
      ...
      answer: "Gen AI Challengers is a platform that integrates advanced technologies like AI and machine learning into agriculture to help farmers optimize their crop yields, manage resources, and make data-driven decisions."
    },
    {
    ...
    {
      question: "Can Gen AI Challengers help with crop recommendation?",
      answer: "Yes, Gen AI Challengers can recommend crops based on soil analysis data, climate conditions, and past crop performance. It helps farmers choose the right crop to maximize yield and maintain soil health."
    },
    {
    ...
    },
    {
      ...
      answer: "Yes, Gen AI Challengers offers tutorials and resources to help farmers learn how to use drones, precision agriculture tools, and AI-based applications for better farm management."
    },
    {
      question: "Can I access weather forecasts on Gen AI Challengers?",
      answer: "Yes, Gen AI Challengers provides real-time weather updates and forecasts, helping farmers plan their activities like sowing, irrigation, and harvesting more effectively."
    },
    {
      question: "How is data security handled on Gen AI Challengers?",
      answer: "Data security is a top priority on Gen AI Challengers. The platform uses encryption and secure servers to ensure that all data, including farm data and user information, is protected."
    },
    {
      question: "What crops can I grow based on soil data?",
      answer: "Gen AI Challengers can analyze soil data and suggest crops that are best suited to the soil's nutrient profile and local climate conditions, maximizing the chances of a good harvest."
    },
    {
      question: "How do I get started with using Gen AI Challengers?",
