...
const Footer = () => {
  ...
  const companyLinks = [{ name: "About Us", path: "/aboutus" }];
      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed max-w-xs">
              Gen AI Challengers platform provides cutting-edge Machine Learning
              models for agricultural predictions and insights.
            </p>
          </div>
                ...
                <li key={link.name}>
                  <Link to={link.path} className="flex items-center group">
                    ...
                    <span className="relative overflow-hidden">
                      ...
                      <span className="absolute top-0 left-0 inline-block transition-transform duration-300 translate-y-full group-hover:translate-y-0 text-lime-200">
                        {link.name}
                      </span>
                    </span>
                  </Link>
        ...
        <div className="mt-8 pt-8 border-t border-white/30 text-center">
          <p className="flex items-center justify-center text-sm">
            Copyright <FaRegCopyright className="mx-1" /> {currentYear} All
            Rights Reserved{" "}
            <span className="font-bold ml-2 bg-white text-emerald-600 px-2 py-1 rounded transition-all duration-300 hover:bg-emerald-600 hover:text-white">
              Gen AI Challengers
            </span>
          </p>
        </div>
